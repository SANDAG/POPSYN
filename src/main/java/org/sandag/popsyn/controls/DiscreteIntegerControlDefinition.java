...
public class DiscreteIntegerControlDefinition<T, ControlDataType>
        extends AbstractControlDefinition<T, ControlDataType>
{
    private Integer defValue = null;

    public DiscreteIntegerControlDefinition(final Class<T> aPersistClass)
    {
        super(aPersistClass);
    }
     ...
     */
    public void setDefValue(Integer aDefValue)
    {
     ...
     * @return  an integer equaling the default value
     */

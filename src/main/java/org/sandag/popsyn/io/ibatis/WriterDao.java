        ...
        implements IWriterDao
{
    ...
    public int persistHouseholds(Integer zoneId, GeographyType geoType, Set<IGeoWeightedObject> households,
        ...
        try
        {
            ...
            if (writeAllocated)
            {
                getSqlMapClientTemplate()
                        .queryForObject("Household.bulkPersistAllocated", filePath);
            } else
            {
                getSqlMapClientTemplate().queryForObject("Household.bulkPersist", filePath);
            }
    ...
    public int persistHouseholds(Integer zoneId, GeographyType geoType, ArrayList<IGeoWeightedObject> households,
            Version version, boolean writeAllocated)
     ...
     * @param zoneId  unique identifier of a zone
     * @param households   a set of balanced households
     * @param writeAllocated  a boolean while true means inserting allocated household, and false mean inserting discretized household

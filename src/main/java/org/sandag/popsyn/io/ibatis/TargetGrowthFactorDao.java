...
/**
 * This class maps targetGrowthFactor objects to the growthFactor table in the database. 
 * It defines methods to access the table.
 *
 */
        ...
        implements ITargetGrowthFactorDao
{
    ...
    public HashMap<Integer, Double> getGrowthFactor(int zone, Version version)
    {
        ...
        List<TargetGrowthFactor> list = (List<TargetGrowthFactor>) getSqlMapClientTemplate()
                .queryForList("TargetGrowthFactor.getGrowthFactor", param);

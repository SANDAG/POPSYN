        ...
        implements IGeographyDao
{
    ...
    {
        return (List<Geography>) getSqlMapClientTemplate().queryForList(
                "Geography.getAllZonesByType", type.getValue());
    }
            ...
            GeographyType subZone)
    {
        ...
        return (List<Geography>) getSqlMapClientTemplate().queryForList(
                "Geography.getAllSubZonesByTypeAndId", qParams);
    }
            ...
            GeographyType superZoneType)
    {
        ...
        return (Geography) getSqlMapClientTemplate().queryForObject(
                "Geography.getSuperZoneByTypeAndId", qParams);
    }
            ...
            GeographyType subZoneType)
    {
        ...
        {
            List<Geography> subZones = this.getAllSubZonesByTypeAndId(superZoneType, superZone
                    .getZone(), subZoneType);
